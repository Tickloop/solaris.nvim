...
function M.brighten(color, lightness_amount, saturation_amount)
  ...
  local hsluv = require("solaris.hsluv")
...
---@param groups solaris.Highlights
...
function M.cache.file(key)
  return vim.fn.stdpath("cache") .. "/solaris-" .. key .. ".json"
end
