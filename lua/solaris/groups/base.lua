...
function M.get(c, opts)
  ...
  return {
    ...
    WinSeparator                = { fg = c.orange, bold = true },
    ...
    PmenuMatchSel               = { bg = Util.blend_bg(c.fg_gutter, 0.8), fg = c.blue },
    ...
    TabLineSel                  = { fg = c.black, bg = c.yellow },
